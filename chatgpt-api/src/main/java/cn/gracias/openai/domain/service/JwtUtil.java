 ...
 * 1. encode()，参数: 签发人，存在时间，一些其他的信息。返回值是JwtToken对应的字符串
...
public class JwtUtil {
    ...
    private static final String defaultBase64EncodedSecreteKey = "B*B^";
    private static final SignatureAlgorithm defaultSignatureAlgorithm = SignatureAlgorithm.HS256;

    public JwtUtil() {
        this(defaultBase64EncodedSecreteKey, defaultSignatureAlgorithm);
    }
    ...
    public String encode(String issuer, long ttlMillis, Map<String, Object> claims) {
        // issuer 签发人，ttlMillis 生存时间，claims 是指还想要在 JWT 中存储的一些非隐私信息
